...
def _render_html(html_code: str):
    """Render HTML reliably without markdown parser converting tags to code blocks."""
...
def render_login_screen():
    ...
    with col_center:
        ...
        login_card_html = f"""<div class="silk-login-wrapper">
...
<div class="silk-feature-desc">Role-based access control & automated reporting</div>
        ...
        _render_html(login_card_html)

        # Action Buttons Container
        if client_id and client_secret:
            auth_url = get_google_auth_url()
            google_btn_html = f"""<a href="{auth_url}" target="_self" class="silk-google-btn">
...
Continue with Google
            ...
            _render_html(google_btn_html)
        else:
            dev_notice_html = """<div class="silk-dev-notice">
🔒 <strong>Google Cloud OIDC</strong> is in standby mode. Use <strong>Demo Access</strong> below to access the full SilkTrace industrial workspace.
        ...
        footer_html = """<div class="silk-login-footer">
